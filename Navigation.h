//
// Created by Brandon Peters on 6/29/2022.
//

#ifndef LAB_02_NAVIGATION_H
...
public:
    ...
    bool readNetwork(string _mapName) = 0;
    ...
    queue<int> computeShortestPath(int _startInd, int _endInd) = 0;

    // prints out to the console the path stored in _path
    void printPath(queue<int> _path) = 0;
};

#endif //LAB_02_NAVIGATION_H
